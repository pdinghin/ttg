...
#if ((defined(TTG_USE_MADNESS) && defined(TTG_USE_PARSEC) || defined(TTG_USE_STARPU) && (defined(TTG_USE_MADNESS) || defined(TTG_USE_PARSEC))) || !(defined(TTG_USE_MADNESS) || defined(TTG_USE_PARSEC) || defined(TTG_USE_STARPU)))
#error \
    "One default implementation must be selected! "\
       "Please select either the PaRSEC backend (TTG_USE_PARSEC) or the MADNESS backend (TTG_USE_MADNESS) or the StarPU backend (TTG_USE_STARPU)"
#endif
